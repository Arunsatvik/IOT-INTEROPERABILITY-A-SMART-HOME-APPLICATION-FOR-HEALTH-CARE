...
public class SemanticAnnotator {
	...
	public Resource createMeasurementInstance(Model model, String measurementURI, Measurement element, String baseName) throws IOException{
		Property hasName = ResourceFactory.createProperty(BodyTemperature_HomeRemedies_ApplicationTutorialMain. NAMESPACE_M3, "hasName"); 
		Property hasValue = ResourceFactory.createProperty(BodyTemperature_HomeRemedies_ApplicationTutorialMain. NAMESPACE_M3, "hasValue"); 
		Property hasTime = ResourceFactory.createProperty(BodyTemperature_HomeRemedies_ApplicationTutorialMain. NAMESPACE_M3, "hasDateTimeValue"); 
		Property hasUnit = ResourceFactory.createProperty(BodyTemperature_HomeRemedies_ApplicationTutorialMain. NAMESPACE_M3, "hasUnit");

		Resource resource = model.createResource(measurementURI);
		resource.addProperty(RDF.type, model.getResource(BodyTemperature_HomeRemedies_ApplicationTutorialMain. NAMESPACE_M3 + "Measurement"));
	...
	public Resource createFeatureOfInterestInstance(Model model, String zone, Resource sensorUri) throws IOException{
		...
		Property observes = ResourceFactory.createProperty(BodyTemperature_HomeRemedies_ApplicationTutorialMain. NAMESPACE_M3, "observes"); 
		Resource featureOfInterestResource = model.createResource(featureOfInterestUri);
		featureOfInterestResource.addProperty(RDF.type, model.getResource(BodyTemperature_HomeRemedies_ApplicationTutorialMain. NAMESPACE_M3 + "FeatureOfInterest"));
	...
	public Resource createSensorInstance(Model model, String sensorName, Resource measurementURI) throws IOException{
		...
		Property produces = ResourceFactory.createProperty(BodyTemperature_HomeRemedies_ApplicationTutorialMain. NAMESPACE_M3, "produces"); 
		Resource resource = model.createResource(sensorURI);
		resource.addProperty(RDF.type, model.getResource(BodyTemperature_HomeRemedies_ApplicationTutorialMain. NAMESPACE_M3 + "Sensor"));
	...
	public Model addTypeSensorMeasurementAccordingToContext(){//Resource measurementURI, Measurement element, String zoneName
		Reasoner reasoner = new GenericRuleReasoner(Rule.rulesFromURL(BodyTemperature_HomeRemedies_ApplicationTutorialMain.RULES_M3_SEMANTIC_ANNOTATION));// read rules
