...
public class BodyTemperature_HomeRemedies_ApplicationTutorialMain {
	...
	// RAW DATA (SEML/XML)
	public static final String HOME_RAW_SENSOR_DATA = "./rawSensorDataset/senMLHealthData.xml";
        public static final String GENERATED_RESULT = "./results/deductions.xml";
...
//	public static final String WEATHER_SEMANTIC_SENSOR_DATA = "./semanticSensorDataset/weatherData_8KB_17Septembre2014.rdf";
	...
	public static final String HOME_ONTOLOGY = "./ontologies/home.owl";
	...
	public static final String HOME_DATASET = "./semanticDomainDataset/home-dataset.rdf";
...
//	public static final String SPARQL_QUERY_NATUROPATHY_MINIMAL = "./sparql/m3SparqlNaturopathyScenarioMinimal.sparql";
	...
	public static final String LINKED_OPEN_RULES_HOME = "./ruleDeduceMeaningfulKnowledge/LinkedOpenRulesHome.txt";
	...
	public static void main(String[] args) {
		...
		try {
			...
			String sensorMeasurements = ReadFile.readContentFile(HOME_RAW_SENSOR_DATA);
			...
			ReadFile.enrichJenaModelOntologyDataset(generic_appli.model, HOME_ONTOLOGY);
			...
			ReadFile.enrichJenaModelOntologyDataset(generic_appli.model, HOME_DATASET);

		
			// STEP: EXECUTING REASONING ENGINE
			Model deduceMeaningfulInformationFromSensorData = 
					generic_appli.executeReasoningEngine(LINKED_OPEN_RULES_HOME);
			...
			var.add(new VariableSparql("inferTypeUri", NAMESPACE_M3 + "RoomTemperature", false));// we look for body temperature measurement
			...
			System.out.println(result);
                        FileWriter fw=new FileWriter(GENERATED_RESULT);
                        fw.write(result);
                        fw.close();
